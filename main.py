...
def load_scenario():
    global graph
    graph = Graph()
    nodes = ["KeOndrae Mell", "Burton Delano", "Roy Cherokee", "Dutch Malcom", "Jamie Roswell", "Warner Thaddeus",
             "Seth Earl", "Crofton Cade"]
    connections = [("KeOndrae Mell", "Burton Delano"), ("KeOndrae Mell", "Roy Cherokee"),
                   ("Roy Cherokee", "Burton Delano"), ("KeOndrae Mell", "Warner Thaddeus"), ("Burton Delano", "Warner Thaddeus"),
                   ("Roy Cherokee", "Seth Earl"), ("Seth Earl", "Jamie Roswell"), ("Jamie Roswell", "Dan Ewing"),
                   ("Dan Ewing", "Dutch Malcom"), ("Micheal Rooker", "Crofton Cade")]
